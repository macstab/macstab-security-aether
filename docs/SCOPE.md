...
> Aether morphs **x86-64** code under an **analysis-gated** policy, proves **0 semantic breaks** on a **≥1k pure-function corpus** plus **structural integrity** on **≥200 ELF-extracted functions**, with **native EAX** dual oracle on lab x86-64 — **lab morph + proof only**, not “undetectable.”
